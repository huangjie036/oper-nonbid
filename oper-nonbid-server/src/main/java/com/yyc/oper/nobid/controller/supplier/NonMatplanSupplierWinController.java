 ...
 * */
@RestController
@RequestMapping(value="/nonMatplanSupplierWin")
@Api(value = "NonMatplanSupplierWinController", tags = "非物资-非招标中标供应商表  ")
public class NonMatplanSupplierWinController {
	...
	public ResultMessage selectByPrimaryKey(@RequestBody SupplierWinRequest record) {
		...
		supplierWinBean.setIsMat("1");//0物资，1非物资
